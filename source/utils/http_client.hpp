...
public:
    ...
    std::string send(http::verb method,std::string host, std::string port, const std::string& target, const std::string& body = "") {
    ...
    std::string get(std::string host, std::string port, const std::string& target, const std::string& body = "") {
        const auto ip = m_resolver.resolve(host, port);
