...
void maybeApplyTextStyle(const boost::property_tree::ptree &ptree, const std::string &sectionKey,
...
view::FtxuiTheme parseFtxuiThemeFromPTree(const boost::property_tree::ptree &ptree,
    ...
    maybeApplyTextStyle(ptree, baseKey + "tags-menu.entry", theme.tagsMenuConfig.entryDecorator);
...
void Configuration::applyDefaults() {
    const auto boldAndInverted = [](const ftxui::Element &elem) { return elem | ftxui::inverted; };

    const auto defaultStyle = [](const ftxui::Element &elem) { return elem; };
                        ...
                        view::FtxuiTheme{
                            ...
                            .tagsMenuConfig =
                                view::MenuConfig{
                                    ...
                                    .entryDecorator = defaultStyle,
                                    .selectedEntryDecorator = boldAndInverted,
                                },
                            .sectionsMenuConfig =
                                view::MenuConfig{
                                    .border = ftxui::BorderStyle::ROUNDED,
