...
public:
    ...
    /**
     * Injects/updates the current object with information parsed from a log entry form a specified date.
     * It will remove/add it to logAvailabilityMap if deleted/written etc.
     */
